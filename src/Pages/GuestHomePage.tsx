...
export default function GuestHomePage(){
    ...
    //Variable used in the guest page to generate IDs for each expense.
    var [generateExpenseID, setGeneratedExpenseID] = useState(0);
    ...
    */
    function CreateNewExpense(event: React.MouseEvent<HTMLButtonElement>){
        ...
        setGeneratedExpenseID(prevID => prevID + 1);
        console.log(expenseObject);
        setExpenseArray(expenseArray => [expenseObject, ...expenseArray]);
    ...
    */
    function SaveEdit(eID : number){
        ...
        return toast.success("Successfully edited expense", {
            position: toast.POSITION.TOP_RIGHT,
        });
    }
